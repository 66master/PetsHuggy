class ListingsController < ApplicationController
  ...
  def update
    if @listing.update(listing_params)
      redirect_to request.referer, notice: "更新できました"
    end
  end
  ...
  private
  def listing_params
    params.require(:listing).permit(:home_type, :pet_type, :breeding_years, :pet_size, :address, :price_pernight)#addressは4-8時点では独自で追加
  end
